...
namespace ANTer.BouncyCastle.AES_CTR_NoPadding  //Crypto.Modes
{
    /**
    ...
    */
    public class SicBlockCipher : IBlockCipher
    {
        ...
        */
        ...
        //0056
        public virtual void Init(bool forEncryption, ICipherParameters parameters) //ignored by this CTR mode
        {
            ...
            this.IV = (byte[])ivParam.GetIV().Clone();
