    ...
    class getMcasName
    {
        ...
        private string GetAmiiboNameMCAS(string AmiiboSer)
        {
            switch (AmiiboSer)
            {
                ...
                case "E94CD68A": return "[AC] 005 - Kapp'n.bin";
                ...
                case "58F2419E": return "[AC] 05 - Cyrus.bin";
                ...
                case "4BD991E8": return "[SPL] 01 - Inkling Boy.bin";
                case "A45D565A": return "[SPL] 02 - Inkling Girl.bin";
                case "8D7AD4A6": return "[SPL] 03 - Inkling Squid.bin";
                case "0567FC5F": return "[SPL] 04 - Callie.bin";
                case "E6A721D4": return "[SPL] 05 - Marie.bin";
                case "692BEE6D": return "[SPL] 06 - Inkling Boy (Purple).bin";
                case "C78C2634": return "[SPL] 07 - Inkling Girl (Lime Green).bin";
                case "6802A56C": return "[SPL] 08 - Inkling Squid (Orange).bin";
                case "079E8BD4": return "[SPL] 09 - Inkling Boy (Neon Green).bin";
                case "57C1235F": return "[SPL] 10 - Inkling Girl (Neon Pink).bin";
                case "2869F678": return "[SPL] 11 - Squid (Neon Purple).bin";
                ...
                case "2E9F7E59": return "[SPL] 12 - Pearl.bin";
                case "2BBE9C60": return "[SPL] 13 - Marina.bin";
                ...
                case "828C833B": return "[SPL] 14 - Octoling Girl.bin";
                case "B66C0B7A": return "[SPL] 15 - Octoling Boy.bin";
                case "E3F6F232": return "[SPL] 16 - Octoling Octopus.bin";
                ...
                case "689781E1": return "[MET] 03 - Samus (Metroid Dread).bin";
                ...
                case "7BDE7C73": return "[YGO] 01 - Yuga Oudou.bin";
                case "49E68A86": return "[YGO] 02 - Tatsuhisa “Luke” Kamijō.bin";
                case "DBA50FB8": return "[YGO] 03 - Gakuto Sōgetsu.bin";
                case "7781CD5F": return "[YGO] 04 - Romin Kirishima.bin";
                case "5755CEE2": return "[YGO] 05 - Roa Kirishima.bin";
                case "4FD0FA58": return "[YGO] 06 - Nail Saionji.bin";
                case "D63B9277": return "[YGO] 07 - Asana Mutsuba.bin";
                case "3C4EDCE8": return "[AC] 401 - Tom Nook.bin";
                case "5E9A3F5E": return "[AC] 402 - Timmy and Tommy.bin";
                case "CE364870": return "[AC] 403 - Isabelle.bin";
                case "4C84A3E6": return "[AC] 404 - Orville.bin";
                case "09639310": return "[AC] 405 - Wilbur.bin";
                case "1FA0C02A": return "[AC] 406 - Blathers.bin";
                case "A5C22981": return "[AC] 407 - Celeste.bin";
                case "BA6DE755": return "[AC] 408 - Mabel.bin";
                case "8798D66A": return "[AC] 409 - Sable.bin";
                case "5BA10889": return "[AC] 410 - Label.bin";
                case "CB1D8924": return "[AC] 411 - K.K.bin";
                case "78EA423B": return "[AC] 412 - C.J.bin";
                case "8FDFF40B": return "[AC] 413 - Flick.bin";
                case "63E1C58D": return "[AC] 414 - Daisy Mae.bin";
                case "A92CA771": return "[AC] 415 - Kicks.bin";
                case "AD0B8AF9": return "[AC] 416 - Saharah.bin";
                case "E22B0A70": return "[AC] 417 - Harvey.bin";
                case "B50C6373": return "[AC] 418 - Gulliver.bin";
                case "E03DC888": return "[AC] 419 - Wisp.bin";
                case "8D415FB5": return "[AC] 420 - Lottie.bin";
                case "300545AB": return "[AC] 421 - Niko.bin";
                case "4EC58275": return "[AC] 422 - Wardell.bin";
                case "ED4599F1": return "[AC] 423 - Tom Nook (Coat).bin";
                case "33BE5A51": return "[AC] 424 - Isabelle (Sweater).bin";
                case "746861E6": return "[AC] 425 - Sherb.bin";
                case "C1F88261": return "[AC] 426 - Megan.bin";
                case "BE7F33CD": return "[AC] 427 - Dom.bin";
                case "26A6AC67": return "[AC] 428 - Audie.bin";
                case "9E6E0BCC": return "[AC] 429 - Cyd.bin";
                case "B97D2995": return "[AC] 430 - Judy.bin";
                case "E6C9363A": return "[AC] 431 - Raymond.bin";
                case "C90AF62B": return "[AC] 432 - Reneigh.bin";
                case "9C7ACFFB": return "[AC] 433 - Sasha.bin";
                case "24FAA84C": return "[AC] 434 - Ione.bin";
                case "DF9B5E9E": return "[AC] 435 - Tiansheng.bin";
                case "B1F840DD": return "[AC] 436 - Shino.bin";
                case "B3DADD22": return "[AC] 437 - Marlo.bin";
                case "38B17628": return "[AC] 438 - Petri.bin";
                case "689DD1F6": return "[AC] 439 - Cephalobot.bin";
                case "84C8946F": return "[AC] 440 - Quinn.bin";
                case "A3ED6FCF": return "[AC] 441 - Chabwick.bin";
                case "49B8A1BA": return "[AC] 442 - Zoe.bin";
                case "DCDB62B8": return "[AC] 443 - Ace.bin";
                case "C570679D": return "[AC] 444 - Rio.bin";
                case "B4EA5CE3": return "[AC] 445 - Frett.bin";
                case "195B3C93": return "[AC] 446 - Azalea.bin";
                case "2CE90F69": return "[AC] 447 - Roswell.bin";
                case "07DC339B": return "[AC] 448 - Faith.bin";
                case "C4051E5E": return "[SPL] 17 - Octoling (Blue).bin";
                case "3DF28DB0": return "[SPL] 18 - Inkling (Yellow).bin";
                case "B310C0D0": return "[SPL] 19 - Smallfry.bin";
                case "1686278D": return "[SSB] 88 - Min Min.bin";
                case "D369C6F1": return "[SSB] 89 - Alex.bin";
                case "3CBC07A9": return "[SSB] 89 - Steve.bin";
                case "D9FE23F0": return "[SSB] 90 - Sephiroth.bin";
                case "33549FCE": return "[SSB] 91 - Kazuya.bin";
                case "939547D4": return "[SSB] 92 - Mythra.bin";
                case "8CD0DA69": return "[SSB] 92 - Pyra.bin";
                case "D0C27CEF": return "[ZTK] 01 - Link.bin";
                case "D19B70BB": return "[ZTK] 02 - Zelda.bin";
                case "E3B25024": return "[ZTK] 03 - Ganondorf.bin";
                ...
                case "094B8EEC": return "[SPL] 23 - Pearl (Side Order).bin";
                case "091015E5": return "[SPL] 24 - Marina (Side Order).bin";
                case "596C79CD": return "[SPL] 25 - Marie (Alterna).bin";
                case "9FEE2604": return "[SPL] 26 - Callie (Alterna).bin";
                case "34286987": return "[SSB] 93 - Sora.bin";
